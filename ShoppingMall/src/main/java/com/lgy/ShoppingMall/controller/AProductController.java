...
//	 	public String productList(Model model, Criteria cri) {
	 	public String productList(Model model, Criteria cri, @RequestParam HashMap<String, String> param) {
...
//			param.put("proCode", lastProCode);
			...
			int proCode = Integer.parseInt(lastProCode) + 1;
			param.put("proCode", String.valueOf(proCode));
			log.info("★param2★"+param);
			
//			// 변경된 부분
//		    int intProCode = Integer.parseInt(param.get("proCode"));
//		    param.put("proCode", String.valueOf(intProCode));
//		    log.info("★param2-1★"+param);
